                ...
                <div key={poll._id} className={styles.card}>
                  ...
                  <div className={styles.cardBody}>
                      ...
                      <div className={styles.optionContainer}>
                        {poll.options.map((opt, i) => (
                          <div 
                            key={i} 
                            className={`${styles.optionBox} ${selected === opt ? styles.optionSelected : '' }`}
                  ...
                  <div className={styles.cardFooter}>
                      ...
                      {new Date() > new Date(poll.expiresAt) && (
                        <div className={styles.footerItem} onClick={() => handleDownload(poll)} style={{ cursor: 'pointer' }}>
                      ...
                      {new Date() > new Date(poll.expiresAt) && (
                        <div className={styles.footerItem}>
                          <Button size="xs" appearance="primary" onClick={() => { setCurrentPollId(poll._id); setChartOpen(true); }}>
                            Xem biểu đồ
                          </Button>
                        </div>
                      )}
